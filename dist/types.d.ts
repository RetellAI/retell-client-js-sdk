...
export type LiveCallUtterance = (Utterance | ToolCallInvocationUtterance | ToolCallResultUtterance | NodeTransitionUtterance | DtmfUtterance | SmsUtterance | InjectedUtterance) & {
    id: string;
    time_sec: number;
};
